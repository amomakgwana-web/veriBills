  ...
  return (
    <label className="flex items-center gap-2">
      ...
      <select
        ...
        className="max-w-[14rem] rounded-lg border border-slate-300 bg-white px-2.5 py-1.5 text-xs font-medium text-slate-700 focus:border-brand-500 focus:outline-none dark:border-slate-700 dark:bg-slate-900 dark:text-slate-200"
      >
        {units.map((unit) => (
